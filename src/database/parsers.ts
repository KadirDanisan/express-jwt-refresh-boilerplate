...
import { Comment, CommentDb } from 'src/modules/comments';
...
export function parseComment(comment: CommentDb) {
    const dateFields = ['createdAt', 'updateAt'] as const;
    
    return parseRow<Comment>(comment, dateFields);
}